...
export const categories = [
  ...
  {
    id: 'coding', name: '코딩 에이전트',
    use: '내 컴퓨터의 파일과 명령을 직접 다루는 것. 이름은 코딩이지만 파일 작업 전반에 쓰인다',
    tools: [
      { name: 'Claude Code', oneLine: '코드베이스를 읽고 파일을 고치고 명령을 실행하는 에이전틱 코딩 도구',
      ...
      { name: 'Codex (OpenAI)', oneLine: 'ChatGPT·CLI·IDE·클라우드에서 도는 OpenAI의 에이전트 제품',
        goodAt: ['클라우드에서 오래 걸리는 작업을 맡겨 두기'],
