...
export default {
  ...
  data: {
    briefCap: '상황',
    brief: '에이전트에게 자료 정리를 맡기고 자리를 비운다. **빨간 것이 사고로 이어지는 작업**이다.\n' +
           '장치는 지나가는 작업을 **전부 붙잡아 검사한다** — 놓을수록 안전하지만 그만큼 느려진다.\n' +
           '오늘 안에 정상 작업 3건을 팀에 넘겨야 한다.',
    ...
    trayLabel: '놓을 안전장치 — 아래 숫자는 지나가는 작업 하나가 그만큼 늦어진다는 뜻이다. 눌러서 집고, 길 위의 빈 자리를 눌러 놓는다',
