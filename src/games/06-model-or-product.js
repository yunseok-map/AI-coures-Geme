...
export default {
  ...
  data: {
    ...
    cards: [
      ...
      { id: 'm2', bin: 'model', text: 'GPT-5 계열',
        why: '모델이다. 제품 이름 ChatGPT와 헷갈리기 쉽다.' },
  ...
  named: {
    all: '엔진이 **모델**, 그 엔진으로 만든 도구가 **제품**, 같은 제품을 쓰는 여러 창구가 **표면**이다. ' +
         '공식 문서의 한 문장이 이 관계를 정확히 말한다 — “Claude Code가 하네스이고, Claude는 그 안에 든 모델이다.” ' +
