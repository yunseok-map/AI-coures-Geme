...
export default {
  ...
  data: {
    ...
    lostTag: '밀려남',
    doneTag: '끝',
    busyNote: '이 창구는 지금 일하는 중이다.',
    goLabel: '오늘 시작',
    runNote: '일감이 들어옵니다. 대기줄에서 집어 창구로 보내세요.',
  ...
  named: {
    all: '방금 한 것은 일에 맞는 창구를 고르는 일이다. 대부분은 어디서도 되지만 ' +
  ...
  debrief: {
    pass: '창구를 고르는 기준은 "무엇이 남는가"다. 자료가 남으면 프로젝트, 결과물이 남으면 아티팩트다.\n' +
          '같은 배경으로 세 번 물어볼 일이면 올려 두는 쪽이 반드시 이긴다 — 두 번째부터 공짜라서다.\n' +
    ...
    fail: '전부 채팅으로 보내면 창구가 하나뿐이라 줄이 선다. 그게 밀려난 일감의 정체다.\n' +
          '그리고 채팅은 파일을 못 건드리고 여러 단계짜리 일도 못 끝낸다 — 시간만 먹고 돌아온다.\n' +
