...
export default {
  ...
  named: {
    all: '방금 한 것은 지도를 읽는 일이다. 같은 일도 가는 길이 여럿이고, ' +
         '갈리는 것은 되냐 안 되냐가 아니라 발품과 남는 것이다. ' +
         '여러 갈래를 한 창에서 골라 쓰게 해주는 층을 **애그리게이터**라고 한다 — ' +
         '벽이 없어 편하지만 그 창 안에 갇힌다. ' +
         '도구 이름 대신 갈래로 외우는 것이 **카테고리로 기억하기**다.'
  },
